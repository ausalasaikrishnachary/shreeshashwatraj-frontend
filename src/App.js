      ...
      <Router>
        <Routes>
          ...
          <Route
            path="/profile/:id"
            element={
              <PrivateRoute allowedRoles={["retailer", "admin"]}>
                <Profile />
              </PrivateRoute>
            }
          />
          ...
          <Route
            path="/reports/retailer-report-page"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <RetailerReportPage />
              </PrivateRoute>
          ...
          />
          <Route
            path="/purchase/debit-note/edit/:id"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <EditDebitNote />
              </PrivateRoute>
          ...
          />
          <Route
            path="/reports/expense-report-page"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <ExpenseReportPage />
              </PrivateRoute>
          ...
          />
          <Route
            path="/sales_visit/edit/:id"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <SalesVisit mode="edit" />
              </PrivateRoute>
            }
          />
          <Route
            path="/sales_visit/view/:id"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <SalesVisit mode="view" />
              </PrivateRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <AdminExpensiveRequest />
              </PrivateRoute>
            }
          />
          <Route
            path="/admin_expensive/view/:id"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <AdminExpensiveRequest mode="view" />
              </PrivateRoute>
            }
          />
          <Route
            path="/admin_expensive/edit/:id"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <AdminExpensiveRequest mode="edit" />
              </PrivateRoute>
            }
          />
          <Route
            path="/salesitems_productdetails/:id"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <Salesitems_productsdetails />
              </PrivateRoute>
            }
          />
          <Route
          ...
          <Route
            path="/reports/sales-report-page"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <SalesReportPage />
              </PrivateRoute>
          ...
          />
          <Route
            path="/credit-period-fix/edit/:id"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <AddCreditPeriodFix />
              </PrivateRoute>
          ...
          />
          <Route
            path="/kachainvoicepdf/:id"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <KachaInvoicePDFPreview />
              </PrivateRoute>
            }
          />
          <Route
          ...
          />
          <Route
            path="/periodinvoicepreviewpdf"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <Period_InvoicePDFPreview />
              </PrivateRoute>
            }
          />
          <Route
            path="/periodinvoicepreviewpdf/:id"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <Period_InvoicePDFPreview />
              </PrivateRoute>
          ...
          />
          <Route
            path="/import_purchase"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <Import_purchase_page />
              </PrivateRoute>
            }
          />
          <Route
            path="/kachapurchaseinvoice"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <KachaPurchaseInvoiceForm />
              </PrivateRoute>
            }
          />
          <Route
            path="/kachapurchasepdf/:id"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <KachaPurchaseInvoicePDFPreview />
              </PrivateRoute>
            }
          />
          <Route
            path="/kachapurchasepdf"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <KachaPurchaseInvoicePDFPreview />
              </PrivateRoute>
          ...
          <Route
            ...
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <KachaPurchaseVochurTable />
              </PrivateRoute>
            }
          />
          <Route
            path="/kachaPurchasevoucherview"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <KachaPurchaseVoucherView />
              </PrivateRoute>
            }
          />
          <Route
            path="/kachaPurchasevoucherview/:id"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <KachaPurchaseVoucherView />
              </PrivateRoute>
          ...
          <Route
            ...
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <Kacha_CreditNoteTable />
              </PrivateRoute>
            }
          />
          <Route
            path="/kachacreditenotetable/:id"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <Kacha_CreditNoteTable />
              </PrivateRoute>
          ...
          />
          <Route
            path="/kachaeditcreditnote"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <Kacha_EditCreditNote />
              </PrivateRoute>
            }
          />
          <Route
            path="/kachaeditcreditnote/:id"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <Kacha_EditCreditNote />
              </PrivateRoute>
          ...
          />
          <Route
            path="/kachadebitnote/:id"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <KachaCreateDebitNote />
              </PrivateRoute>
            }
          />
          <Route
          ...
          />
          <Route
            path="/kachadebitenoteview/:id"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <KachaPurchaseDebitView />
              </PrivateRoute>
            }
          />
          <Route
            path="/kachapurchaseedit/:id"
            element={
              <PrivateRoute allowedRoles={["admin"]}>
                <KachaPurchaseInvoiceEdit />
              </PrivateRoute>
            }
          />
          <Route
