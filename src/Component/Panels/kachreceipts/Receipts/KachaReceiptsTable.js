...
const KachaReceiptsTable = () => {
  ...
  const fetchInvoices = async () => {
    try {
      ...
      const response = await fetch(
        `${baseurl}/api/vouchersnumber?type=stock transfer`,
      );
  ...
  const fetchReceipts = async () => {
    try {
      ...
      const response = await fetch(
        `${baseurl}/api/receipts?data_type=stock transfer`,
      );
  ...
  const handleDownload = async () => {
    try {
      ...
      console.log(
        `Downloading ${filteredReceipts.length} Kacha receipts for:`,
        month,
        year,
      );
  ...
  const handleDownloadRange = async () => {
    try {
      ...
      console.log(
        `Downloading ${filteredReceipts.length} Kacha receipts for date range:`,
        startDate,
        "to",
        endDate,
      );
