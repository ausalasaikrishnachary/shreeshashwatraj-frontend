...
const InvoicePDFPreview = () => {
  ...
  const [receiptFormData, setReceiptFormData] = useState({
    ...
    invoiceNumber: '',
  transactionProofFile: null // Make sure this is here
  });



// Update the handleFileChange function (around line 60):
const handleFileChange = (e) => {
  ...
  if (file) {
    ...
    // Use receiptFormData instead of formData
...
// Add this function for file removal
...
{/* Around line 1102, update the file input section: */}
<div className="mb-3">
