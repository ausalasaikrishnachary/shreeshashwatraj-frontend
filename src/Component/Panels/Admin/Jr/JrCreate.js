          ...
          <Container fluid className="entries-container">
            ...
            <div className="bg-white p-3 rounded shadow-sm mb-4">
              ...
              <div className="d-flex align-items-end gap-2 flex-wrap">
                <div
                  style={{ minWidth: "200px", flex: 2, position: "relative" }}
                  ref={dropdownRef}
                >
                        ...
                        {loading ? (
                          ...
                          filteredAccounts.map((account) => (
                            ...
                            >
                              ...
                              >
                                Balance: ₹{safeToFixed(account.balance)} (
                    ...
                    {journalItems.length === 0 ? (
                      <tr>
                        <td colSpan={6} className="text-center text-muted py-3">
                          No entries added. Please add entries using the form
                          above.
                        </td>
                      </tr>
                    ) : (
                      journalItems.map((item) => (
                        <tr key={item.id}>
                          ...
                          <td className="text-end">
                            ₹{safeToFixed(item.balance)} ({item.balance_type})
                          </td>
                          <td className="text-end">
                          ...
                          <td className="text-center">
                            <span
                              className={`badge ${item.amountType === "Dr" ? "bg-danger" : "bg-success"}`}
                            >
                              {item.amountType}
                            </span>
                          </td>
                          <td className="text-end">
                            <span
                              className={
                                item.newBalanceType === "Dr"
                                  ? "text-danger"
                                  : "text-success"
                              }
                            >
                              ₹{safeToFixed(item.newBalance)} (
                              {item.newBalanceType})
                            </span>
                          </td>
                          <td>
            ...
            <div className="text-center bg-white p-3 rounded shadow-sm mt-4">
              <Button
                ...
                title={
                  journalItems.length > 0 && !isBalanced
